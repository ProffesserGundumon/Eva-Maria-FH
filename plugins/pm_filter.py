...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("💢𝔾𝕆 𝕋𝕆 𝔹𝔸ℂ𝕂ℙ𝔸𝔾𝔼💢", callback_data=f"next_{req}_{key}_{off_set}"), InlineKeyboardButton(f"📃 Pages {round(int(offset)/10)+1} / {round(total/10)}", callback_data="pages")]
        )
        ...
        btn.append(
            [
                InlineKeyboardButton("💢𝔾𝕆 𝕋𝕆 𝔹𝔸ℂ𝕂ℙ𝔸𝔾𝔼💢", callback_data=f"next_{req}_{key}_{off_set}"),
                InlineKeyboardButton(f"🗓 {round(int(offset)/10)+1} / {round(total/10)}", callback_data="pages"),
                InlineKeyboardButton("💢𝔾𝕆 𝕋𝕆 ℕ𝔼𝕏𝕋ℙ𝔸𝔾𝔼💢", callback_data=f"next_{req}_{key}_{n_offset}")
            ],
        )
    try:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('🤴ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ🤴', url=f'http://t.me/SBKUNJAVA')
            ],[
            InlineKeyboardButton('🔍 Search Here', switch_inline_query_current_chat=''),
            InlineKeyboardButton('🤖 Updates', url='https://t.me/Film_House2')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('🛑My Group🛑', url='https://t.me/Film_House2'),
            InlineKeyboardButton('🛑My Channel🛑', url='https://t.me/SB_Movies1')
            ],[
            InlineKeyboardButton('🤴My Developer🤴', url='https://t.me/SBKUNJAVA')
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('🤖 Updates', url='https://t.me/Film_House2'),
            InlineKeyboardButton('🤴ᴏᴡɴᴇʀ', url='https://t.me/SBKUNJAVA')
            ],[
            InlineKeyboardButton('🏠 Home', callback_data='start'),
            InlineKeyboardButton('🔐 Close', callback_data='close_data')
        ]]
